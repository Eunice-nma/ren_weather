            ...
            child: viewModel.loading
                ...
                : Column(
                    ...
                    children: [
                          ...
                          child: Column(
                            ...
                            children: [
                              Row(
                                children: [
                                  Text(
                                    '${viewModel.cityWeatherList[0].weather?.temperature ?? '_ _'} °C',
                      ...
                      CarouselSlider(
                        items: [
                          ...List.generate(viewModel.cityWeatherList.length,
                              (index) {
                            return Container(
                              width: 220,
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    viewModel
                                        .cityWeatherList[index].city.cityName,
                                    style: const TextStyle(
                                        color: Colors.white, fontSize: 20),
                                  ),
                                  if (viewModel
                                          .cityWeatherList[index].weather !=
                                      null) ...[
                                    Image.network(viewModel.getWeatherIconUrl(
                                      viewModel
